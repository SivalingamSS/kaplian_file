namespace filter_data.Model
{
    public class Enroll
    {
        ...
        public class total
        {
            public object? ConfirmatNumber { get; set; }
            public object? ComName { get; set; }
            public object? DOB { get; set; }
            public object? PaymentCode { get; set; }
            public object? UtilityActNum { get; set; }
            public object? ContractSignDate { get; set; }
            public object? DivCode { get; set; }
            public object? CreDate { get; set;}
